...
RENAME_MAP = {
    # 쿠팡 CSV 파일명(=상품명) → 캐노니컬
    # (2026-09-10 사용자 확정: "팔꿈치 마사지기"로 통일 — "프리미엄 엘보케어 팔꿈치
    #  마사지기"라는 표기는 쓰지 않음. patch_relink_prev_month.py 로 3~7월과 이름을
    #  맞춰 전월 대비(prev_review_count)가 정상 연결되도록 함께 처리했음.)
    ...
    "슬룸 팔꿈치 마사지기 안마기 EMS TENS 온열 엘보 전완근 무선 휴대용": "팔꿈치 마사지기",
